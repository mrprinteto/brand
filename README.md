# MrPrinteto — Brand Rules

> **LLM instruction block.** Copy the section below into any project's system prompt or `.instructions.md` to apply MrPrinteto brand rules consistently.
